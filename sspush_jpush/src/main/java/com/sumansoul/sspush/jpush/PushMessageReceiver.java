...
public class PushMessageReceiver extends JPushMessageReceiver {
    ...
    public void onMessage(Context context, CustomMessage message) {
        ...
        SSPushCore.transmitMessage(context, message.message, message.extra, null);
    }
    ...
    public void onNotifyMessageOpened(Context context, NotificationMessage message) {
        ...
        try {
            SSPushCore.transmitNotificationClick(context, message.notificationId, message.notificationTitle, message.notificationContent, null,
                    PushUtils.toMap(new JSONObject(message.notificationExtras)));
        } catch (Exception e) {
            e.printStackTrace();
            SSPushCore.transmitNotificationClick(context, message.notificationId, message.notificationTitle, message.notificationContent, message.notificationExtras, null);
        }
    }
    ...
    public void onNotifyMessageArrived(Context context, NotificationMessage message) {
        ...
        try {
            SSPushCore.transmitNotification(context, message.notificationId, message.notificationTitle, message.notificationContent, null,
                    PushUtils.toMap(new JSONObject(message.notificationExtras)));
        } catch (Exception e) {
            e.printStackTrace();
            SSPushCore.transmitNotification(context, message.notificationId, message.notificationTitle, message.notificationContent, message.notificationExtras, null);
        }
    }
    ...
    public void onConnected(Context context, boolean isConnected) {
        ...
        SSPushCore.transmitConnectStatusChanged(context, isConnected ? CONNECTED : DISCONNECT);
    }
    ...
    public void onTagOperatorResult(Context context, JPushMessage jPushMessage) {
        SSPushCore.transmitCommandResult(context, jPushMessage.getSequence(),
