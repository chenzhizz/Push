...
public class JPushClient implements IPushClient {
    ...
    public static final int JPUSH_PLATFORM_CODE = 1001;
    ...
    public void register() {
        ...
        if (!TextUtils.isEmpty(token)) {
            SSPushCore.transmitCommandResult(mContext, TYPE_REGISTER, RESULT_OK, token, null, null);
        }
    }
    ...
    public void unRegister() {
        ...
        mHandler.postDelayed(new Runnable() {
            ...
            public void run() {
                if (JPushInterface.isPushStopped(mContext)) {
                    SSPushCore.transmitCommandResult(mContext, TYPE_UNREGISTER, RESULT_OK, null, null, null);
                }
            }
        }, 200);
    }
