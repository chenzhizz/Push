...
import com.sumansoul.push.util.Utils;
...
public final class PendingIntentUtils {
    ...
    public static PendingIntent buildActivityIntent(Class<? extends Activity> clazz, int requestCode, int flags) {
        ...
        return PendingIntent.getActivity(SSPushCore.getContext(), requestCode, intent, flags);
    }
    ...
    public static PendingIntent buildBroadcastIntent(String action, int requestCode) {
        ...
        return PendingIntent.getBroadcast(SSPushCore.getContext(), requestCode, intent, PendingIntent.FLAG_UPDATE_CURRENT);
    }
