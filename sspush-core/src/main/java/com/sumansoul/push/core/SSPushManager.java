...
package com.sumansoul.push.core;


import androidx.annotation.NonNull;

import com.sumansoul.push.core.queue.IMessageFilter;
import com.sumansoul.push.core.queue.IMessageFilterStrategy;
import com.sumansoul.push.core.queue.IMessageObservable;
import com.sumansoul.push.core.queue.IMessageObserver;
import com.sumansoul.push.core.queue.impl.DefaultMessageFilterStrategyImpl;
import com.sumansoul.push.core.queue.impl.DefaultMessageObservableImpl;
import com.sumansoul.push.entity.CustomMessage;
import com.sumansoul.push.entity.Notification;
 ...
 */
public class SSPushManager implements IMessageObservable {

    private static volatile SSPushManager sInstance = null;
     ...
     * @return
     */
    public static SSPushManager get() {
        if (sInstance == null) {
            synchronized (SSPushManager.class) {
                if (sInstance == null) {
                    sInstance = new SSPushManager();
                }
            }
        }
        return sInstance;
     ...
     * @return
     */
    public SSPushManager setIMessageObservable(@NonNull IMessageObservable observable) {
     ...
     */
    @Override
    public void notifyCommandResult(SSPushCommand command) {
        if (mObservable != null) {
     ...
     * @return
     */
    public SSPushManager setIMessageFilterStrategy(@NonNull IMessageFilterStrategy messageFilterStrategy) {
     ...
     * @param filter 消息过滤器
     */
    public SSPushManager addFilter(@NonNull IMessageFilter filter) {
     ...
     * @param filter 消息过滤器
     */
    public SSPushManager addFilter(int index, @NonNull IMessageFilter filter) {
        if (mMessageFilterStrategy != null) {
     ...
     * @param filters 消息过滤器
     */
    public SSPushManager addFilters(@NonNull IMessageFilter... filters) {
        if (mMessageFilterStrategy != null) {
     ...
     * @param filters 消息过滤器
     */
    public SSPushManager setFilters(@NonNull IMessageFilter... filters) {
        if (mMessageFilterStrategy != null) {
