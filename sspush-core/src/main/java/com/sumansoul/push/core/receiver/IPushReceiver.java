...
package com.sumansoul.push.core.receiver;
...
public interface IPushReceiver {
     ...
     * @param msg     消息
     */
    void onNotification(Context context, SSPushMsg msg);
     ...
     * @param msg     消息
     */
    void onNotificationClick(Context context, SSPushMsg msg);
     ...
     * @param msg     消息
     */
    void onMessageReceived(Context context, SSPushMsg msg);
     ...
     */
    void onCommandResult(Context context, SSPushCommand command);
